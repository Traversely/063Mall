    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="{{url('admin/banner')}}" method="post" enctype="multipart/form-data" onsubmit="return doSubmit()">
                {{ csrf_field('bannerCreate') }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">商品ID</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="gid" id="inputEmail3" placeholder="请输入要链接到的商品ID">
